...
This package includes:
 ...
 - User Vouch-Proxy (with Nginx) to enable authentication using CILogon
...
## API
API Documentation can be found [here](https://app.swaggerhub.com/apis-docs/kthare10/credmgr/1.0.0-oas3)
